...
ma.ipd.seq.expr(1:k,k) # 0.2280216
ma.ipd.seq.expr(NULL,0) # 0.257906
(ma.ipd.seq.expr(NULL,0)-ma.ipd.seq.expr(1:k,k))/ma.ipd.seq.expr(1:k,k) #0.1310598
(ma.ipd.seq.expr(NULL,0)-ma.ipd.seq.expr(1:k,k))/ma.ipd.seq.expr(NULL,0) #0.1158734

test = optimal.seq(5) # 0.2323259 
(test[[3]]-ma.ipd.seq.expr(NULL,0))/ma.ipd.seq.expr(NULL,0) #-0.09918395
