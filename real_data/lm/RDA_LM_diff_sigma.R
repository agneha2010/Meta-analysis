...
ma.ipd.seq.expr(1:k,k) # 0.03348677
ma.ipd.seq.expr(NULL,0) # 0.03774574
(1/ma.ipd.seq.expr(NULL,k)-1/ma.ipd.seq.expr(1:k,0))/(1/ma.ipd.seq.expr(1:k,k)) #-0.1128332
(1/ma.ipd.seq.expr(1:k,k)-1/ma.ipd.seq.expr(NULL,0))/(1/ma.ipd.seq.expr(NULL,k)) #0.1271838


test = optimal.seq(5) # 0.03518727    
(test[[3]]-ma.ipd.seq.expr(NULL,0))/ma.ipd.seq.expr(NULL,0) #-0.09716474 
(1/test[[3]]-1/ma.ipd.seq.expr(NULL,0))/(1/ma.ipd.seq.expr(NULL,0)) #0.1076218
(1/ma.ipd.seq.expr(NULL,k)-1/test[[3]])/(1/ma.ipd.seq.expr(1:k,k)) #0.05170018
