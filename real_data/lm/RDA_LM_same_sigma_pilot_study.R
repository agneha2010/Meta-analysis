...
ma.ipd.seq.expr(1:k,k) # 0.07585883
ma.ipd.seq.expr(NULL,0) # 0.08860372
(1/ma.ipd.seq.expr(1:k,k)-1/ma.ipd.seq.expr(NULL,0))/(1/ma.ipd.seq.expr(1:k,k)) #0.1438415


test = optimal.seq(5) # 0.07999457   
