...
(1/ma.ipd.seq.expr(1:k,k)-1/ma.ipd.seq.expr(NULL,0))/(1/ma.ipd.seq.expr(1:k,k)) #-0.1498298
...
(1/test[[3]]-1/ma.ipd.seq.expr(NULL,0))/(1/ma.ipd.seq.expr(NULL,0)) #-0.1498298
(1/ma.ipd.seq.expr(1:k,k)-1/test[[3]])/(1/ma.ipd.seq.expr(1:k,k)) #-0.1498298
